...
public class modelisc extends AbstractTableModel {
	...
	private String[] tableHeaders = {"Id Ordine","Data","Tesserato","Modalità Pagamento","Prezzo Totale","Confermato","Annullato","Modificato"};
	@Override
	...
	public Object getValueAt(int rowIndex, int columnIndex) {
		...
		else if(columnIndex==7) return d.getModificato();
		  return null;
    ...
    public void setValueAt(Object aValue, int rowIndex, int columnIndex) {
        ...
        if(columnIndex==7) dati.get(rowIndex).setModificato((int)aValue);
