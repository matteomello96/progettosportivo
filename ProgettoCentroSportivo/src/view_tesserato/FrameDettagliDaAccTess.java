...
public class FrameDettagliDaAccTess extends JFrame {
	...
	public JPanel contentPane,pannello,Panel1,PanelBottom2;
	public JButton bottone;
	public JButton bottone1,bottone3;
	
	
	public FrameDettagliDaAccTess(int cod) {
		...
		mntmNewMenuItem.setActionCommand("elord");
		...
		contentPane.add(VariListener.SettaPannelloTitolo(im3, Panel1, 2, 2,"Dettagli ordine da accettare"), BorderLayout.NORTH);
		...
		public void actionPerformed(ActionEvent arg0) {
			...
			orario=(String) table_2.getValueAt(table_2.getSelectedRow(), 6);
				...
				frame.dispose();
				new FrameModificaTurno(disciplina,livello,tesserato);
