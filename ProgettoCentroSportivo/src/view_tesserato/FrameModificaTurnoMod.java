...
public class FrameModificaTurnoMod extends JPanel {
	/**
	 * 
	 */
	...
	public String ora=(String) FrameDettagliModTess2.table_2.getValueAt(FrameDettagliModTess2.table_2.getSelectedRow(), 6);
	public String giorno=(String) FrameDettagliModTess2.table_2.getValueAt(FrameDettagliModTess2.table_2.getSelectedRow(), 5);
	...
	public FrameModificaTurnoMod(String disciplina, String livello,int tesserato) {
		...
		JMenuItem mntmNewMenuItem = new JMenuItem("Torna agli ordini modificati");
		mnNewMenu.add(mntmNewMenuItem);
		mntmNewMenuItem.addActionListener(new Listen(this));
		mntmNewMenuItem.setActionCommand("mt3");
		...
		public void actionPerformed(ActionEvent arg0) {
			if(table2.getSelectedRow()!=-1){
				   ...
				   String  giorno2 =	(String) FrameModificaTurnoMod.table2.getValueAt(FrameModificaTurnoMod.table2.getSelectedRow(), 0);
				   String orario2= (String) FrameModificaTurnoMod.table2.getValueAt(FrameModificaTurnoMod.table2.getSelectedRow(), 1);
				    codiceturno = GetInfoDB.getcodiceturno2(disciplina,livello ,giorno2 ,orario2);
			        int iddet= GetInfoDB.getiddet3(disciplina, livello, tesserato,(String) FrameDettagliModTess2.table_2.getValueAt(FrameDettagliModTess2.table_2.getSelectedRow(), 5), (String) FrameDettagliModTess2.table_2.getValueAt(FrameDettagliModTess2.table_2.getSelectedRow(), 6));
			        JOptionPane.showMessageDialog(frame,""+iddet+""+""+giorno2+""+orario2+"");
			        int codturnoprec=GetInfoDB.getcodiceturno2(disciplina, livello, (String) FrameDettagliModTess2.table_2.getValueAt(FrameDettagliModTess2.table_2.getSelectedRow(), 5), (String) FrameDettagliModTess2.table_2.getValueAt(FrameDettagliModTess2.table_2.getSelectedRow(), 6));
					postidisponibili = GetInfoDB.getprenotazioni(codiceturno);
					if(postidisponibili==0){
						JOptionPane.showMessageDialog(FrameDettagliModTess2.frame, "Posti massimi raggiunti"," ",JOptionPane.WARNING_MESSAGE);	
					}
					else{
					
					Modifica_Turno_Dao.ModificaDaMod(livello,disciplina,giorno2,orario2,tesserato,iddet,codturnoprec);
