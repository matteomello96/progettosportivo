...
public class FrameDettagliConfTess extends JFrame {
	...
	public FrameDettagliConfTess(int cod) {
		...
		contentPane.add(VariListener.SettaPannelloTitolo(im3, Panel1, 2, 2,"Dettagli ordine confermato"), BorderLayout.NORTH);
		...
		public void actionPerformed(ActionEvent arg0) {
			...
			String disciplina,livello,giorno,orario;
					...
					tesserato=(int) FrameIscrDisc.table.getValueAt(FrameIscrDisc.table.getSelectedRow(), 2);
		
			
			
			
				frame.dispose();
				new FrameModificaTurnoConf(disciplina,livello,tesserato);
