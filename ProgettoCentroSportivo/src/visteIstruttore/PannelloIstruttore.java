...
public class PannelloIstruttore extends JFrame {
	/**
	 * 
	 */
	...
	public JPanel contentPane,tabellaPnl,tabellaPnl2,bottoniPnl1,bottoniPnl2,Panel1,Panel2,Panel3;
    	...
    	public PannelloIstruttore() {
    		frame = new JFrame();
    		String username=""+Utente.getUsername()+"";
    		frame.setTitle("Pannello di controllo istruttore "+username+"");
    		...
    		JMenuItem mntmNewMenuItem_2 = new JMenuItem("I tuoi eventi");
    		...
    		JMenuItem mntmNewMenuItem_3 = new JMenuItem("Le tue attività");
