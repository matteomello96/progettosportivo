...
public class TriggerPartecipantiEv {
	...
	public static String spazio;
	 ...
	 public static PDDocument writePDF(String giornoset,String fasciaoraria,String spazio) {
 		...
 		df.setRoundingMode(RoundingMode.HALF_EVEN);
			try {
	    		...
	    		for(int c=0;c<DetPartEv.table1.getRowCount();c++)
	    		{
	    		
	    			s0=DetPartEv.table1.getValueAt(c, 0).toString();
	    			s1=DetPartEv.table1.getValueAt(c, 1).toString();
	 ...
	 public static String scriviDistinta(){
 		...
 		for(int c=0;c<DetPartEv.table1.getRowCount();c++)
 		{
 			...
 			s0=DetPartEv.table1.getValueAt(c, 0).toString();
 		    s3=DetPartEv.table1.getValueAt(c, 1).toString();
