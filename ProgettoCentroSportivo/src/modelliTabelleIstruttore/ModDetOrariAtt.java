...
public class ModDetOrariAtt extends AbstractTableModel {
	   /**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	private ArrayList<DettagliOrariAtt> dati;
		
		public ArrayList<DettagliOrariAtt> getDati() {
			return dati;
		}

		public ModDetOrariAtt (ArrayList<DettagliOrariAtt> dati) {
			super();
			this.dati = dati;
		}
		...
		public Object getValueAt(int rowIndex, int columnIndex) {
			...
			//ArrayList<Utente>
			//data binding
			DettagliOrariAtt d=dati.get(rowIndex);
