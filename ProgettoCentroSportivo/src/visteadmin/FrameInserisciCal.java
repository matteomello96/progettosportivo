...
public class FrameInserisciCal extends JFrame {
	...
	public FrameInserisciCal() {
		...
		JLabel lblFormDiModifica = new JLabel("Form di Inserimento del Calendario");
		...
		JLabel lblLiv = new JLabel("Nome del calendario da inserire");
		...
		JButton btnRegistratiAlNostro = new JButton("Inserisci calendario");
