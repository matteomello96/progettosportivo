...
public class FrameInserisciCal extends JFrame {
	...
	public FrameInserisciCal() {
		...
		if(FrameInserisciCal.frame==null)
			frame.setLocationRelativeTo(null);
			else
			frame.setLocation(FrameInserisciCal.frame.getLocation());
		...
		mntmTornaAllaPagina.setActionCommand("Vai_ges_da_ins_cal");
    ...
    contentPane.add(VariListener.SettaPannelloTitolo(im3, Panel1, 1, 0, "Form di inserimento calendario"), BorderLayout.NORTH);	
	...
	VariListener.SettaTextField(Panel2, textliv, "Inserisci", 1,1);
	VariListener.SettaFocus(textliv);
		...
		PanelBottom.setBackground(new Color (255,185,0));
		 ...
		 JLabel lbl= new JLabel();
		  ...
		  VariListener.SettaBtn(PanelBottom, btnRegistratiAlNostro, lbl,"Inserisci calendario", 1, 1,im2,true);
		...
		if(textliv.getText().isEmpty())
			...
			bool=GestioneDAO.inserimentocal(textliv.getText());
