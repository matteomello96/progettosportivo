...
public class FrameModificaLiv extends JFrame {
    ...
    contentPane.add(VariListener.SettaPannelloTitolo(im3, Panel1, 1, 0, "Form di modifica livello"), BorderLayout.NORTH);	
	...
	VariListener.SettaFocus(textliv);
		...
		PanelBottom.setBackground(new Color (255,185,0));
		 ...
		 JLabel lbl= new JLabel();
		  ...
		  VariListener.SettaBtn(PanelBottom, btnRegistratiAlNostro, lbl,"modifica livello", 1, 1,im2,true);
